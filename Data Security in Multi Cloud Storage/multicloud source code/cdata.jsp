...
String sss1 = "select *from cloud1 ";
	...
	onm=rss.getString(1);
		...
		%>
	 <tr bgcolor="#6699ff"><td><font size="3" color="white"><%=rs.getString(1)%><td><font size="3" color="white"><%=rs.getString(2)%><td><a href="cdata2.jsp?id=<%=rs.getString(1)%>"><font size="3" color="white">View</a><td><font size="3" color="white"><%=onm %><td>
	 <%
	}
  }
  catch(Exception e){
