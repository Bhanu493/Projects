...
<body>
        ...
        <div class="register">
          <h1>File Download</h3>
          <form id="reg-form" action="decrypt.jsp" method="post">
            <div>
...
%>
			...
			<div>
              <label for="email">&nbsp;DecryptKey</label>
             
            </div><div>
              <label for="email"></label>
              <input type="text" name="sk" value=<%=sk%> readonly>  
            </div>
            <div>
              <label></label>
              <input type="submit" value="     Decrypt    " id="create-account" class="button"/>
            </div>
          </form>
